...
def train_pcc50_regression():
    TARGET_NAME_FOR_MODEL = config.LOG_TARGET_CC50
    TASK_NAME = "pCC50_Regression"
    ...
    models_params = {
        ...
        # "CatBoostRegressor": (CatBoostRegressor(random_state=config.RANDOM_STATE, verbose=0), {
    ...
    estimators_for_stacking = [
        ('rf',
         RandomForestRegressor(n_estimators=100, random_state=config.RANDOM_STATE, max_depth=10, min_samples_leaf=5)),
        ('xgb', XGBRegressor(n_estimators=100, learning_rate=0.05, max_depth=3, random_state=config.RANDOM_STATE,
